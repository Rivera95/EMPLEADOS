...
if($_POST){
    ...
    $sentencia = $conexion->prepare("UPDATE tbl_empleados 
                                    SET primernombre=:primernombre, segundonombre=:segundonombre, primerapellido=:primerapellido,segundoapellido=:segundoapellido, idpuesto=:idpuesto, fechadeingreso=:fechadeingreso
                                    WHERE id=:id");
...
<h2 class="mt-5">Formulario para la editada de empleado</h2>
<div class="card">
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
             ...
             <input type="file"
               class="form-control mt-1" name="foto" id="foto" aria-describedby="helpId">
            </div>
